  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        },
        {
          name: "New Search",
          icon: Search,
          path: "/new-domain/search",
        },
        {
          name: "Recent Hits",
          icon: History,
          path: "/new-domain/recent-searches",
        }
      ]
    },
    {
      ...
      <div className="p-6 border-b border-sidebar-border/50">
        <div className="flex items-center gap-3 px-2">
          <div className="w-9 h-9 rounded-xl bg-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-600/20 group relative overflow-hidden">
            <Calendar className="w-5 h-5 text-white relative z-10 group-hover:scale-110 transition-transform" />
            <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          </div>
          <div>
            <h2 className="text-sm font-bold text-sidebar-foreground tracking-tight uppercase">New Domain</h2>
            <p className="text-[10px] text-sidebar-foreground/50 font-medium uppercase tracking-wider">Tracker Engine</p>
          </div>
        </div>
      </div>
