...
const navItems = [
  { to: "/no-website", label: "Dashboard", icon: LayoutDashboard },
  { to: "/no-website/search", label: "New Search", icon: Search },
  { to: "/no-website/recent-searches", label: "Recent Searches", icon: Database },
  { to: "/no-website/settings", label: "Settings", icon: Settings },
];

export function NoWebsiteSidebar() {
  return (
      ...
      <div className="p-6 border-b border-sidebar-border bg-gradient-to-br from-primary/5 to-transparent">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-xs font-medium">Finder + Outreach</p>
          </div>
        </div>
      </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-2xl p-5 border border-primary/20 shadow-lg">
          ...
          <div className="relative z-10 space-y-3">
            ...
            <p className="text-muted-foreground text-xs leading-relaxed">
              Configure outreach settings for automated $399 website pitch emails
            </p>
