...
export const KyptronixFormSidebar = () => {
            ...
            items: [
                {
                    name: "Contact Us",
                    icon: FileText,
                    path: "/kyptronix-form/contact-us",
                },
                {
                    name: "Company Profile",
                    icon: FileText,
                    path: "/kyptronix-form/download-company-profile",
                },
                {
                    name: "Business Card",
                    icon: FileText,
        ...
        <aside className="w-64 bg-sidebar-background border-r border-sidebar-border flex flex-col h-full bg-gradient-to-b from-sidebar-background to-sidebar-background/95">
            <div className="p-6 border-b border-sidebar-border/50">
                <div className="flex items-center gap-3 px-2">
                    ...
                    <div>
                        <h2 className="text-sm font-bold text-sidebar-foreground">Kyptronix Forms</h2>
                        <p className="text-[10px] text-sidebar-foreground/50 font-medium uppercase tracking-wider">Submission Manager</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-auto p-4 border-t border-sidebar-border/50">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-transparent border border-indigo-500/10">
                    ...
                    <p className="text-[10px] text-sidebar-foreground/50 leading-relaxed font-medium">
                        Monitor user interactions across all entry points.
                    </p>
                </div>
            </div>
        </aside>
