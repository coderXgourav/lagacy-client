...
const navItems = [
    { to: "/system-role", label: "Dashboard", icon: LayoutDashboard },
    { to: "/system-role/settings", label: "Settings", icon: Settings },
];

export function SystemRoleSidebar() {
    return (
            ...
            <div className="p-6 border-b border-sidebar-border bg-gradient-to-br from-primary/5 to-transparent">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-xs font-medium">Growth Agent</p>
                    </div>
                </div>
            </div>
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-2xl p-5 border border-primary/20 shadow-lg">
                    ...
                    <div className="relative z-10 space-y-3">
                        ...
                        <p className="text-muted-foreground text-xs leading-relaxed">
                            Review generated content frequently to train the AI with your brand voice.
                        </p>
